      ...
      addManufacturingRigButton = [
        Padding(
            ...
            child: DropdownMenuFlyout(
              current: 'Add Rigs',
              items: controller.getAvailableManufacturingRigs().map((e) => e.name).toList(),
              style: style,
              parentController: flyoutController,
              ids: controller.getAvailableManufacturingRigs().map((e) => e.tid).toList(),
    ...
    if (controller.getNumSelectedReactionRigs() < maxNumRigs) {
      addReactionRigButton = [
        Padding(
            ...
            child: DropdownMenuFlyout(
              current: 'Add Rigs',
              items: controller.getAvailableReactionRigs().map((e) => e.name).toList(),
              style: style,
              parentController: flyoutController,
              ids: controller.getAvailableReactionRigs().map((e) => e.tid).toList(),
