        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.int;
              t2 = type$.nullable_void_Function_Event._as(new A.main_closure(new A.ServerImplementation(new A.DatabaseConnection(new A.WebDatabase(new A._WebDelegate(new A._IndexedDbStorage("EveReactorCache", false, true), null, null), false, true, new A.Lock(), new A.Lock())), false, A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.QueryExecutor), A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.CancellationToken_dynamic), A._setArrayType([], type$.JSArray_int), A.StreamController_StreamController$broadcast(true, type$.void), A.LinkedHashSet_LinkedHashSet$_empty(type$.DriftCommunication), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void))));
              type$.nullable_void_Function._as(null);
