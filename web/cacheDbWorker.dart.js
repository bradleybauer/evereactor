...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DriftCommunication: function DriftCommunication(t0, t1, t2, t3, t4, t5) {
      ...
      _._pendingRequests = t4;
      _._incomingRequests = t5;
    },
  ...
  A.ServerImplementation.prototype = {
    serve$1(channel) {
      ...
      comm = new A.DriftCommunication(channel, true, true, t2, A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.Completer_dynamic), A.StreamController_StreamController(null, null, true, type$.Request_2));
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait($async$self.block.call$0(), $async$call$0);
            case 6:
              // returning from await.
              t1 = $async$result;
              $async$returnValue = t1;
...
//# sourceMappingURL=cacheDbWorker.dart.js.map
