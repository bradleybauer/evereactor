// Generated by dart2js (NullSafetyMode.sound, csp), the Dart to JavaScript compiler version: 2.18.0-77.0.dev.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    DriftRuntimeOptions: function DriftRuntimeOptions() {
    },
    ...
    PortToChannel_channel(_this) {
      ...
      controller.set$__StreamChannelController__local(A.GuaranteeChannel$(new A._ControllerStream(foreignToLocalController, t2._eval$1("_ControllerStream<1>")), new A._StreamSinkWrapper(localToForeignController, t3._eval$1("_StreamSinkWrapper<1>")), true, t1));
      ...
      if (controller.__StreamChannelController__foreign !== $)
      ...
      t3 = controller.__StreamChannelController__local;
      if (t3 === $)
        A.throwLateFieldNI("_local");
      t3 = t3.__GuaranteeChannel__sink;
      if (t3 === $)
        A.throwLateFieldNI("_sink");
      new A._MapStream(t2, new A._EventStream(_this, "message", false, t1), t1._eval$1("_MapStream<Stream.T,@>")).pipe$1(t3);
      t3 = controller.__StreamChannelController__local;
      if (t3 === $)
        A.throwLateFieldNI("_local");
      t3 = t3.__GuaranteeChannel__streamController;
      if (t3 === $)
      ...
      t3 = controller.__StreamChannelController__foreign;
      if (t3 === $)
  ...
  A.DriftCommunication.prototype = {
    ...
    _send$1(msg) {
      ...
      t1 = this._channel.__GuaranteeChannel__sink;
      if (t1 === $)
        A.throwLateFieldNI("_sink");
  ...
  A.ServerImplementation.prototype = {
    serve$1(channel) {
      ...
      t3 = channel.__GuaranteeChannel__streamController;
      if (t3 === $)
        A.throwLateFieldNI("_streamController");
  ...
  A.DriftRuntimeOptions.prototype = {};
  ...
  A._BaseExecutor.prototype = {
    ...
    _log$2(sql, args) {
      var t1, t2;
      if (this.get$logStatements()) {
        t1 = $.$get$driftRuntimeOptions();
        t2 = A.S(args);
        t1.toString;
        A.print("Drift: Sent " + sql + " with args " + t2);
      }
    },
  ...
  A._BaseExecutor_runDelete_closure.prototype = {
    call$0() {
      ...
      t1._log$2(t2, t3);
      t1 = t1.get$impl();
      t4 = t1.___WebDelegate__db;
      if (t4 === $)
        A.throwLateFieldNI("_db");
  ...
  A._BaseExecutor_runCustom_closure.prototype = {
    call$0() {
      ...
      t1 = t1.get$impl().___WebDelegate__db;
      if (t1 === $)
        A.throwLateFieldNI("_db");
      t1.runWithArgs$2(t2, resolvedArgs);
      return A.Future_Future$value(null, type$.void);
    },
    $signature: 5
  };
  A._BaseExecutor_runBatched_closure.prototype = {
    call$0() {
      var t2, t3,
        t1 = this.$this;
      if (t1.get$logStatements()) {
        t2 = $.$get$driftRuntimeOptions();
        t3 = this.statements.toString$0(0);
        t2.toString;
        A.print("Drift: Executing " + t3 + " in a batch");
      }
      ...
      var $async$store$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.___IndexedDbStorage__database;
              if (t1 === $)
                A.throwLateFieldNI("_database");
  ...
  A._WebDelegate.prototype = {
    ...
    runBatched$1(statements) {
      ...
      for (t2 = statements.statements, t3 = t2.$ti, t2 = new A.ListIterator(t2, t2.get$length(t2), t3._eval$1("ListIterator<ListMixin.E>")), t4 = type$.JsObject, t3 = t3._eval$1("ListMixin.E"); t2.moveNext$0();) {
        ...
        if (t6 === $)
          A.throwLateFieldNI("_db");
        t1.push(new A.PreparedStatement(t4._as(t6._obj.callMethod$2("prepare", [t5]))));
      }
      ...
      var $async$runInsert$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.___WebDelegate__db;
              if (t1 === $)
                A.throwLateFieldNI("_db");
              ...
              if (t1 === $)
                A.throwLateFieldNI("_db");
              insertId = A._asInt(t1._selectSingleRowAndColumn$1("SELECT last_insert_rowid();"));
              $async$goto = 3;
    ...
    runSelect$2(statement, args) {
      ...
      if (t1 === $)
        A.throwLateFieldNI("_db");
      t1 = t1.prepare$1(statement)._obj;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (t1 === $)
                A.throwLateFieldNI("_db");
              modified = A._asInt(t1._obj.callMethod$1("getRowsModified"));
          ...
          switch ($async$goto) {
            ...
            case 2:
              ...
              if (t1 === $)
                A.throwLateFieldNI("_db");
              $async$goto = 4;
              return A._asyncAwait($async$self.storage.store$1(type$.Uint8List._as(t1._obj.callMethod$1("export"))), $async$_storeDb$0);
            case 4:
              // returning from await.
            case 3:
              // join
      ...
      var $async$get$schemaVersion = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.delegate.___WebDelegate__db;
              if (t1 === $)
                A.throwLateFieldNI("_db");
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (t1 === $)
                A.throwLateFieldNI("_db");
              t1._obj.callMethod$2("run", ["PRAGMA user_version = " + version]);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.main_closure.prototype = {
    call$1($event) {
      var t1;
      A.print(" web worker event hai ");
      t1 = type$.MessageEvent._as($event).ports;
      t1.toString;
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "core__print$closure", "print", 2);
    ...
    _instance_1_u(A.DriftCommunication.prototype, "get$_handleMessage", "_handleMessage$1", 2);
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "driftRuntimeOptions", "$get$driftRuntimeOptions", () => new A.DriftRuntimeOptions());
  })();
...
//# sourceMappingURL=persistenceWorker.dart.js.map
